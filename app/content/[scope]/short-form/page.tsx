...
export default async function ShortFormPage({
  ...
  const pieces = await getContentPieces(scope as ContentScope, "short_form");
  return <ContentListClient pieces={pieces} scope={scope as ContentScope} kind="short_form" />;
}
